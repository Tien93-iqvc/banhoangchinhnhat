			...
			<h1>Trường Đại Học Quy Nhơn</h1>
				...
				<!--form-stars-here-->
						<div class="form-w3-agile">
							<h2>Đăng Nhập</h2>
							<form action="codeindex.php" method="post">
								...
								<p class="p-bottom-w3ls1">Đổi mật khẩu?<a class href="formdmk.php"> Click vào  </a></p>
								<p class="p-bottom-w3ls">Đăng ký tài khoản?<a class href="formdk.php"> Đăng ký </a></p>
								<div class="clear"></div>
