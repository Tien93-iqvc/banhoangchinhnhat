...
<div class="container demo-1">
	<div class="content">
        <div id="large-header" class="large-header">
			<h1>Trường Đại Học Quy Nhơn</h1>
				<div class="main-agileits">
				<!--form-stars-here-->
						<div class="form-w3-agile">
							<h2>Đổi mật khẩu</h2>
							<form action="codedmk.php" method="POST">
								...
								<div class="form-sub-w3">
									<input type="password" name="mkc" placeholder="Mật khẩu" required="" />
								<div class="icon-w3">
									<i class="fa fa-unlock-alt" aria-hidden="true"></i>
								</div>
                                </div>
                                <div class="form-sub-w3">
									<input type="password" name="mkm1" placeholder="Mật khẩu mới" required="" />
								<div class="icon-w3">
									<i class="fa fa-unlock-alt" aria-hidden="true"></i>
								</div>
								</div>
								<div class="form-sub-w3">
									<input type="password" name="mkm2" placeholder="Nhập lại mật khẩu" required="" />
								<div class="icon-w3">
									<i class="fa fa-unlock-alt" aria-hidden="true"></i>
								</div>
								</div>
								...
								<div class="submit-w3l">
									<input type="submit" value="Đổi mật khẩu" name="login">
								</div>
							</form>	
						</div>
        </div>
